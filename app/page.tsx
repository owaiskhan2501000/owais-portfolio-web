...
export default function Home() {
  ...
  const t = useMemo(() => ({
    en: {
      greeting: "Hi, I'm",
      name: "Mohammad Owais",
      role: "AI Researcher  •  2D Animator  •  Web And App Developer",
      bio: "BS Computer Science graduate at the intersection of AI research, creative animation, and modern web engineering. I turn complex ideas into elegant, performant digital experiences.",
      ...
      timeline: [
        ...
        { year: "2026", title: "BS Computer Science", desc: "Graduated with a focus on Artificial Intelligence and Web Technologies. Awarded the Front-End Developer Award.", icon: "🏫" },
        { year: "2025–26", title: "Final Year Projects & Freelance", desc: "Built real-time Face Mask Detection system (OpenCV + TensorFlow); freelanced on branding projects.", icon: "🚀" },
      ],
    ...
    zh: {
      ...
      timeline: [
        ...
        { year: "2026", title: "计算机科学学士", desc: "已毕业，专注于人工智能和网络技术。荣获前端开发者奖项。", icon: "🏫" },
        { year: "2025–26", title: "毕业设计与自由职业", desc: "构建了实时口罩检测系统；承接品牌设计项目。", icon: "🚀" },
      ],
      skillsTitle: "技术栈",
      skills: [
        { name: "Python & AI/ML", level: 90, icon: "🐍" },
