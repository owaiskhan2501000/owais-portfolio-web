...
export default function Home() {
  ...
  const projects = useMemo(() => [
    ...
    { id: 3, title: lang === "en" ? "AI-Powered Image Upscaler" : "AI 驱动的图像放大器", category: "AI / Computer Vision", description: lang === "en" ? "An advanced image upscaling tool built using the Real-ESRGAN deep learning model to enhance image resolution and restore details perfectly." : "使用 Real-ESRGAN 深度学习模型构建的高级图像放大工具，可完美提高图像分辨率并恢复细节。", techStack: ["Python", "PyTorch", "Real-ESRGAN", "OpenCV"], githubLink: "https://github.com/owaiskhan2501000", color: "from-blue-500/20 to-indigo-500/20" },
